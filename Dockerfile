...
WORKDIR /go/src/github.com/insighted4/forestry
...
COPY --from=builder /usr/share/forestry /usr/share/forestry
RUN ln -s /usr/share/forestry/bin/forestry /usr/bin/forestry

# Run the web service on container startup.
CMD ["forestry", "version"]
